...
<div class="news_w">
	...
	<div class="newsList">
		<div class="news">
			<img src="<?php bloginfo('template_directory'); ?>/img/13_2e4417f0.png" alt="Дорогие друзья, мы рады приветствовать вас на официальном сайте ТД “Фермеръ”!">
			<a href="/news/news/" class="title db">Дорогие друзья, мы рады приветствовать вас на официальном сайте ТД “Фермеръ”!</a>
			<p>В разделе “Производство” мы подробно рассказали о технологиях, которые используем при приготовлении блюд, чтобы наши готовые обеды долго оставались свежими и сохраняли для вас свои полезные свойства.
			</p>
			<a class="more" href="/news/news/">Читать дальше </a>
